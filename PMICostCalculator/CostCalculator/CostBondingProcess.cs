...
{
    public partial class CostBondingProcess : Form
    {
        public event EventHandler<CostCalculatorArgs> FillIn;
        public CostBondingProcess()
        {
            InitializeComponent();
        ...
        private void CostBondingProcess_Load(object sender, EventArgs e)
        {
            txtUnitCost.Text = Properties.Settings.Default.UnitCostBonding.ToString("N2");
        }
    }
}
