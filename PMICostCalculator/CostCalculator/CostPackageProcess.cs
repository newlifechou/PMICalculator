...
{
    public partial class CostPackageProcess : Form
    {
        public event EventHandler<CostCalculatorArgs> FillIn;
        public CostPackageProcess()
        {
            InitializeComponent();
            FormOperate.SetFormToDialog(this, false);
        }

        private void CostPackageProcess_Load(object sender, EventArgs e)
        {
            txtUnitCost.Text = Properties.Settings.Default.UnitCostPackage.ToString("N2");
        }
