...
{
    public partial class CostDeliveryProcess : Form
    {
        public event EventHandler<CostCalculatorArgs> FillIn;
        public CostDeliveryProcess()
        {
            InitializeComponent();
            FormOperate.SetFormToDialog(this, false);
        }

        private void CostDeliveryProcess_Load(object sender, EventArgs e)
        {
            txtUnitCost.Text = Properties.Settings.Default.UnitCostDelivery.ToString("N2");
        }
